class GoodOlHUDStatusBar : HexenStatusBar
{
    HUDFont GOHmHUDFont;
    ...
    protected virtual void GOHDrawStatusTimers(int coordbasex, int coordbasey)
    {
        ...
        static const Name StatusDefinitions[] =
        {
            ...
            "PigPlayer",   "brown",     "[Brown]" // Pig morph doesn't have a Powerup actor; handle it differently as a result
        };
