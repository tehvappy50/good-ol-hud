class GoodOlHUDStatusBar : GoodOlHUDSquareStatusBar
{
    HUDFont GOHmHUDFont;
    ...
    protected virtual void GOHDrawMugShot(int coordbasex, int coordbasey)
    {
        ...
        if (CPlayer.ReadyWeapon && CPlayer.ReadyWeapon.GetClassName() == "SauceWeapon") { DrawImage("graphics/hud/goodolhud_PF_YIKES.png", (coordbasex + 19.6, coordbasey + 17.5), DI_SCREEN_LEFT_BOTTOM|DI_ITEM_CENTER, GOHHideOnDeath(1., PlayerDeadTimerCheckMugshot), (35, 31)); }
