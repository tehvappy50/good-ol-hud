class GoodOlHUDStatusBar : HereticStatusBar
{
    HUDFont GOHmHUDFont;
    ...
    protected void GOHDrawFullScreenStuff ()
    {
        ...
        String invulnbarcolor = "gold";
        let invulntextcolor = Font.CR_GOLD;
    ...
    protected virtual void GOHDrawPowerupTimers(int coordbasex, int coordbasey)
    {
        ...
        {
            "PowerInvulnerable", "gold",   "[Gold]",
            "PowerWeaponLevel2", "red",    "[Red]",
    ...
    protected virtual void GOHDrawStatusTimers(int coordbasex, int coordbasey)
    {
        ...
        static const Name StatusDefinitions[] =
        {
            ...
            "ChickenPlayer", "white",     "[White]" // Chicken morph doesn't have a Powerup actor; handle it differently as a result
        };
